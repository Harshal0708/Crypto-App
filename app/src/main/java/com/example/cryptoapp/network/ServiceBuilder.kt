...
class ServiceBuilder(context5: Context,isBoolean: Boolean) {
    ...
    private val client = OkHttpClient.Builder()
        ...
        .addInterceptor(OAuthInterceptor("Bearer", context5,isBoolean))
    ...
    private val retrofit = Retrofit.Builder()
        .baseUrl(
        if(isBoolean == true){
            Constants.STRIPE_PAYMENT_URL
        }else{
            Constants.LOCAl_URL
        }


        ) // change this IP for testing by your actual machine IP
